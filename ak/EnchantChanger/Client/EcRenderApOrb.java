...
public class EcRenderApOrb extends Render
{
    ...
    public EcRenderApOrb()
    {
        this.shadowSize = 0.15F;
        this.shadowOpaque = 0.75F;
    }

    public void func_35438_a(EcEntityApOrb par1EntityXPOrb, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
        ...
        float var26 = 255.0F;
        float var27 = ((float)par1EntityXPOrb.apColor + par9) / 2.0F;
    ...
    {
        this.func_35438_a((EcEntityApOrb)par1Entity, par2, par4, par6, par8, par9);
    }
}
