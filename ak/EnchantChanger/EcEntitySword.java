...
public class EcEntitySword extends Entity
{
	...
	public EcEntitySword(World par1World, EntityLiving par2EntityLiving, double par3, double par5, double par7)
	{
		super(par1World);
		this.enemyEntity = par2EntityLiving;
		this.setSize(Size, Size);
	...
	{
		if (!this.worldObj.isRemote && (this.enemyEntity != null && this.enemyEntity.isDead || !this.worldObj.blockExists((int)this.posX, (int)this.posY, (int)this.posZ)))
		{
			this.setDead();
		}
		else
	 ...
	 public boolean attackEntityFrom(DamageSource par1DamageSource, int par2)
	 {
		 ...
		 if (par1DamageSource.getEntity() != null)
		 {
			 ...
			 {
				 this.enemyEntity = (EntityLiving)par1DamageSource.getEntity();
			 }
