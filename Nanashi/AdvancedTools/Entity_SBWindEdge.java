...
public class Entity_SBWindEdge extends Entity
{
	...
	public Entity_SBWindEdge(World var1, EntityLiving var2, float var3)
	{
		super(var1);
		this.Init();
		this.yOffset = 0.0F;
	 ...
	 public void setVelocity(double var1, double var3, double var5)
	{
	 ...
	 public void onUpdate()
	 {
		 ...
		 else
		 {
			 ...
			 int var31 = this.worldObj.getBlockId(this.xTile, this.yTile, this.zTile);

			 if (var31 > 0)
			 {
				 Block.blocksList[var31].setBlockBoundsBasedOnState(this.worldObj, this.xTile, this.yTile, this.zTile);
				 AxisAlignedBB var2 = Block.blocksList[var31].getCollisionBoundingBoxFromPool(this.worldObj, this.xTile, this.yTile, this.zTile);
			 ...
			 {
				 ++this.ticksInAir;
				 Vec3 var32 = this.worldObj.getWorldVec3Pool().getVecFromPool(this.posX, this.posY, this.posZ);
				 ...
				 MovingObjectPosition var4 = this.worldObj.rayTraceBlocks_do_do(var32, var3, false, true);
				 var32 = this.worldObj.getWorldVec3Pool().getVecFromPool(this.posX, this.posY, this.posZ);
