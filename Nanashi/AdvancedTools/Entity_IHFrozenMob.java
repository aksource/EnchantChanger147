...
//					this.altenativeMethodForAI();
	...
	private void originalMethodForAI()
	{
		...
		ObfuscationReflectionHelper.setPrivateValue(EntityLiving.class, this.frozen, new EntityAITasks(this.worldObj.theProfiler), 59);
	}
	...
	public void onUpdate()
	{
	 ...
	 public void setDead()
	 {
		 if(this.entityTasks != null){
			 ObfuscationReflectionHelper.setPrivateValue(EntityLiving.class, this.frozen, this.entityTasks, 59);
