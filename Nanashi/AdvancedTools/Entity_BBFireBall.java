...
public class Entity_BBFireBall extends Entity
{
	...
	public void setEntityDead()
	{
		...
		if (!this.isWet())
		{
			...
			if (this.worldObj.getBlockId(var3, var8, var5) == 0 && Block.fire.canPlaceBlockAt(this.worldObj, var3, var8, var5))
			{
				this.worldObj.setBlockWithNotify(var3, var8, var5, Block.fire.blockID);
			}
	...
	public Entity_BBFireBall(World var1, EntityLiving var2, float var3, boolean var4)
	{
		super(var1);
		this.Init();
		this.yOffset = 0.0F;
	 ...
	 public void setVelocity(double var1, double var3, double var5)
	{
	 ...
	 public void onUpdate()
	 {
		 ...
		 if (var17 > 0)
		 {
			 Block.blocksList[var17].setBlockBoundsBasedOnState(this.worldObj, this.xTile, this.yTile, this.zTile);
			 AxisAlignedBB var2 = Block.blocksList[var17].getCollisionBoundingBoxFromPool(this.worldObj, this.xTile, this.yTile, this.zTile);
		 ...
		 if (!this.inGround && this.ticksInAir <= 15)
		 {
			 ...
			 MovingObjectPosition var4 = this.worldObj.rayTraceBlocks_do_do(var18, var3, false, true);
