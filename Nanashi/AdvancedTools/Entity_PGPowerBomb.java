...
public class Entity_PGPowerBomb extends Entity
{
	...
	public void setEntityDead()
	{
		...
		List var1 = this.worldObj.getEntitiesWithinAABB(EntityLiving.class, this.boundingBox.expand(5.0D, 5.0D, 5.0D));
		int var2;
	...
	public Entity_PGPowerBomb(World var1, EntityPlayer var2, float var3)
	{
		...
		MovingObjectPosition var12 = this.worldObj.rayTraceBlocks_do_do(var10, var11, false, true);
