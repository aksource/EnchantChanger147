...
public class Entity_AIGCreeperSwell extends EntityAIBase
{
    /** The creeper that is swelling. */
	Entity_GoldCreeper swellingCreeper;
    ...
    public Entity_AIGCreeperSwell(Entity_GoldCreeper par1EntityCreeper)
    {
