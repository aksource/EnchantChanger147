...
@TransformerExclusions({"AKCore.asm"})
public class AKCore implements IFMLLoadingPlugin
{
    ...
    {
        return new String[]{"AKCore.asm.TransformerBeacon"};
    }
    ...
    {
        return "AKCore.asm.ps147ModContainer";
    }
