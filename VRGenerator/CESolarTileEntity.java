...
//	{
//		return world.isDaytime() && !world.provider.hasNoSky && world.canBlockSeeTheSky(i, j, k) && ((world.getWorldChunkManager().getBiomeGenAt(i, k) instanceof BiomeGenDesert) || !world.isRaining() && !world.isThundering());
//	}
    public static boolean isSunVisible(World world, int i, int j, int k)
    {
